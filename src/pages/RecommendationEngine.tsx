...
const ScholarshipStep = ({ selectedValue, onChange }) => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold mb-6 text-center">
        Do you fall under any of these scholarship categories?
      </h2>
      ...
      <div className="bg-blue-50 rounded-lg p-4 text-center">
        ...
        <p className="text-sm">
          Get information about various scholarships you may be eligible for!
        </p>
      </div>
    </div>
  );
...
const UserDetailsStep = ({ userDetails = {} as UserDetails, onChange }) => {
  return (
    <div>
      <h2 className="text-2xl font-semibold mb-6 text-center">
        Almost there! Share your details to get personalized recommendations
      </h2>
      ...
      <div className="bg-blue-50 rounded-lg p-4 text-center">
        ...
        <p className="text-sm">
          We respect your privacy and will only use your information to provide you with personalized recommendations.
        </p>
      </div>
    </div>
  );
